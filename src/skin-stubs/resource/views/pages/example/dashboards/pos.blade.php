<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('dashboard.pos') }}
    @endsection
                    ...
                    <ul class="nav nav-pills d-flex justify-content-between nav-pills-custom gap-3 mb-6">
                        ...
                        <li class="nav-item mb-3 me-0">
                            ...
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg show active" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 138px;height: 180px">
                                ...
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('assets/media/svg/food-icons/spaghetti.svg') }}" class="w-50px" alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                                <!--begin::Info-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            ...
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg" data-bs-toggle="pill" href="#kt_pos_food_content_2" style="width: 138px;height: 180px">
                                ...
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('assets/media/svg/food-icons/salad.svg') }}" class="w-50px" alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                                <!--begin::Info-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            ...
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg" data-bs-toggle="pill" href="#kt_pos_food_content_3" style="width: 138px;height: 180px">
                                ...
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('assets/media/svg/food-icons/cheeseburger.svg') }}" class="w-50px" alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                                <!--begin::Info-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            ...
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg" data-bs-toggle="pill" href="#kt_pos_food_content_4" style="width: 138px;height: 180px">
                                ...
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('assets/media/svg/food-icons/coffee.svg') }}" class="w-50px" alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                                <!--begin::Info-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            ...
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg" data-bs-toggle="pill" href="#kt_pos_food_content_5" style="width: 138px;height: 180px">
                                ...
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('assets/media/svg/food-icons/cheesecake.svg') }}" class="w-50px" alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                                <!--begin::Info-->
                            ...
                            <div class="d-flex flex-wrap d-grid gap-5 gap-xxl-9">
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-2.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-7.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-8.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-4.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-10.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-9.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-3.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-5.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                                ...
                                <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                    ...
                                    <div class="card-body text-center">
                                        <!--begin::Food img-->
                                        <img src="{{ asset('assets/media/stock/food/img-11.jpg') }}" class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px" alt="" />
                                        <!--end::Food img-->
                                        <!--begin::Info-->
                                        <div class="mb-2">
                                            <!--begin::Title-->
                        ...
                        <table class="table align-middle gs-0 gy-4 my-0">
                            ...
                            <tbody>
                                <tr data-kt-pos-element="item" data-kt-pos-item-price="33">
                                    <td class="pe-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/media/stock/food/img-2.jpg') }}" class="w-50px h-50px rounded-3 me-3" alt="" />
                                ...
                                <tr data-kt-pos-element="item" data-kt-pos-item-price="7.5">
                                    <td class="pe-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/media/stock/food/img-9.jpg') }}" class="w-50px h-50px rounded-3 me-3" alt="" />
                                ...
                                <tr data-kt-pos-element="item" data-kt-pos-item-price="13.5">
                                    <td class="pe-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('assets/media/stock/food/img-3.jpg') }}" class="w-50px h-50px rounded-3 me-3" alt="" />
