<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('dashboard.ecommerce') }}
    @endsection
                    ...
                    <ul class="nav nav-pills nav-pills-custom mb-3">
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            ...
                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_1">
                                <!--begin::Icon-->
                                <div class="nav-icon">
                                    <img alt="" src="{{ asset('assets/media/svg/products-categories/t-shirt.svg') }}" class="" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Subtitle-->
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            ...
                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_2">
                                <!--begin::Icon-->
                                <div class="nav-icon">
                                    <img alt="" src="{{ asset('assets/media/svg/products-categories/gaming.svg') }}" class="" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Subtitle-->
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            ...
                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_3">
                                <!--begin::Icon-->
                                <div class="nav-icon">
                                    <img alt="" src="{{ asset('assets/media/svg/products-categories/watch.svg') }}" class="" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Subtitle-->
                        ...
                        <li class="nav-item mb-3 me-3 me-lg-6">
                            ...
                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_4">
                                <!--begin::Icon-->
                                <div class="nav-icon">
                                    <img alt="" src="{{ asset('assets/media/svg/products-categories/gloves.svg') }}" class="nav-icon" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Subtitle-->
                        ...
                        <li class="nav-item mb-3">
                            ...
                            <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_5">
                                <!--begin::Icon-->
                                <div class="nav-icon">
                                    <img alt="" src="{{ asset('assets/media/svg/products-categories/shoes.svg') }}" class="nav-icon" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Subtitle-->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/210.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/215.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/209.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/197.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                                <span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-4312</span>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/178.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/22.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/1.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/24.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/71.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/41.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/63.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/59.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                                <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/10.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/96.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('assets/media/stock/ecommerce/13.png') }}" class="w-50px ms-n1" alt="" />
                                            </td>
                                            <td class="ps-0">
                    ...
                    <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                        ...
                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ asset('assets/media/stock/ecommerce/210.png') }}" class="w-50px ms-n1 me-1" alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                        ...
                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ asset('assets/media/stock/ecommerce/209.png') }}" class="w-50px ms-n1 me-1" alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                        ...
                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ asset('assets/media/stock/ecommerce/214.png') }}" class="w-50px ms-n1 me-1" alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                        ...
                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ asset('assets/media/stock/ecommerce/211.png') }}" class="w-50px ms-n1 me-1" alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">Elephant 1802</a>
                                    <!--end::Title-->
                        ...
                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ asset('assets/media/stock/ecommerce/215.png') }}" class="w-50px ms-n1 me-1" alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
                                    <!--end::Title-->
                        ...
                        <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                            ...
                            <div class="d-flex flex-stack mb-3">
                                ...
                                <div class="me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ asset('assets/media/stock/ecommerce/192.png') }}" class="w-50px ms-n1 me-1" alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                                    <a href="apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
                                    <!--end::Title-->
