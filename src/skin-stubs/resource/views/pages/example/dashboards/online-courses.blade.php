<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('dashboard.online-courses') }}
    @endsection
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center me-3">
                            <!--begin::Logo-->
                            <img src="{{ asset('assets/media/svg/brand-logos/bootstrap5.svg') }}" class="me-4 w-30px" alt="" />
                            <!--end::Logo-->
                            <!--begin::Section-->
                            <div class="flex-grow-1">
                                <!--begin::Text-->
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center me-3">
                            <!--begin::Logo-->
                            <img src="{{ asset('assets/media/svg/brand-logos/angular-icon.svg') }}" class="me-4 w-30px" alt="" />
                            <!--end::Logo-->
                            <!--begin::Section-->
                            <div class="flex-grow-1">
                                <!--begin::Text-->
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center me-3">
                            <!--begin::Logo-->
                            <img src="{{ asset('assets/media/svg/brand-logos/typescript-1.svg') }}" class="me-4 w-30px" alt="" />
                            <!--end::Logo-->
                            <!--begin::Section-->
                            <div class="flex-grow-1">
                                <!--begin::Text-->
