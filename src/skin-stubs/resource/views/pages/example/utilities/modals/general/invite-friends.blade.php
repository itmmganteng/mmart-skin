<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('utilities.modals.general.invite-friends') }}
    @endsection
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="text-center pb-15 px-5">
                <img src="{{ asset('assets/media/illustrations/sketchy-1/1.png') }}" alt="" class="mw-100 h-200px h-sm-325px" />
            </div>
            <!--end::Illustration-->
        </div>
        <!--end::Card body-->
