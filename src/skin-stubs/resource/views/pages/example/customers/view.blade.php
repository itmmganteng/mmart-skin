                        ...
                        <div class="card-body pt-0 pb-5">
                            ...
                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
                                ...
                                <tbody class="fs-6 fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">1457-8227</a>
                                        </td>
                                        <td>
                                            <span class="badge badge-light-success">Successful</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">1633-3625</a>
                                        </td>
                                        <td>
                                            <span class="badge badge-light-success">Successful</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">1055-4320</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">5704-3854</a>
                                        </td>
                                        <td>
                                            <span class="badge badge-light-success">Successful</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">2655-5375</a>
                                        </td>
                                        <td>
                                            <span class="badge badge-light-success">Successful</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">3977-4797</a>
                                        </td>
                                        <td>
                                            <span class="badge badge-light-success">Successful</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">9481-7984</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">1324-1015</a>
                                        </td>
                                        <td>
                                            <span class="badge badge-light-warning">Pending</span>
                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="min-w-400px">
                                            ...
                                            <a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2023, 10:30 am</td>
                                    </tr>
                                    <tr>
                                        <td class="min-w-400px">Invoice
                                        ...
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2023, 6:05 pm</td>
                                    </tr>
                                    <tr>
                                        <td class="min-w-400px">Invoice
                                            <a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#DER-45645</a>status has changed from
                                    ...
                                    <tr>
                                        <td class="min-w-400px">
                                            <a href="#" class="text-gray-600 text-hover-primary me-1">Max Smith</a>has made payment to
                                            <a href="#" class="fw-bold text-gray-900 text-hover-primary">#SDK-45670</a></td>
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2023, 6:43 am</td>
                                    </tr>
                                </tbody>
                            </table>
                            <!--end::Table-->
