<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('ecommerce.sales.add-order') }}
    @endsection
                ...
                <div class="card-body pt-0">
                    <div class="d-flex flex-column gap-10">
                        ...
                        <div class="fv-row">
                            ...
                            <div class="fw-bold fs-3">#13835</div>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02244009</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_2">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">25.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03612007</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_3">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">124.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02326007</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_4">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03188008</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_5">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">108.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03665004</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_6">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">37.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04439004</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_7">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">240.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04410007</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_8">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">265.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04427007</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_9">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02493006</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_10">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">251.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 01987002</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_11">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02633006</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_12">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">260.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03763005</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_13">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 01832001</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_14">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04747008</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_15">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04621002</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_16">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 01885002</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_17">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 01224009</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_18">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04874002</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_19">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">19.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02153009</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_20">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04250008</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_21">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03883008</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_22">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03540007</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_23">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">189.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02434002</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_24">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03101004</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--begin::Price-->
                                                <div class="fw-semibold fs-7">Price: $
                                                <span data-kt-ecommerce-edit-order-filter="price">158.00</span></div>
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03615003</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_26">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 04599003</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_27">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02699005</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_28">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 02182005</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_29">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 01610002</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_30">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <!--end::Price-->
                                                <!--begin::SKU-->
                                                <div class="text-muted fs-7">SKU: 03506008</div>
                                                <!--end::SKU-->
                                            </div>
                                        </div>
                                    </td>
