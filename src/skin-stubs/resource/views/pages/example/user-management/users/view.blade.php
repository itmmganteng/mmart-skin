<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('user-management.users.view') }}
    @endsection
                ...
                <div class="card-body">
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">20 Jun 2023, 10:30 am</div>
                            <!--begin::Details item-->
                        </div>
                    </div>
                    <!--end::Details content-->
                                ...
                                <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>POST /v1/invoice/in_7559_8260/invalid</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>POST /v1/customer/c_654c70251fee9/not_found</td>
                                            <td class="pe-0 text-end min-w-200px">10 Nov 2023, 10:10 pm</td>
                                        </tr>
                                        <tr>
                                            <td class="min-w-70px">
                                                <div class="badge badge-light-success">200 OK</div>
                                            </td>
                                            <td>POST /v1/invoices/in_6298_1313/payment</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>POST /v1/invoices/in_4045_8788/payment</td>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#LOP-45640</a>has been
                                        <span class="badge badge-light-danger">Declined</span></td>
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2023, 6:05 pm</td>
                                    </tr>
                                    <tr>
                                        <td class="min-w-400px">
                                        <a href="#" class="text-gray-600 text-hover-primary me-1">Sean Bean</a>has made payment to
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2023, 5:20 pm</td>
                                    </tr>
                                    <tr>
                                        <td class="min-w-400px">Invoice
                                        ...
                                        <span class="badge badge-light-info">In Progress</span></td>
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2023, 5:20 pm</td>
                                    </tr>
                                </tbody>
                            </table>
                            <!--end::Table-->
